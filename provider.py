...
class OpCodes():
    ...
    def __init__(self):
        self.instructions = {}
        self.instructions["and"] = OpCode(
            "and", InstructionType.R, "1100", "000")
        self.instructions["or"] = OpCode(
            "or", InstructionType.R, "1100", "001")
        self.instructions["xor"] = OpCode(
            "xor", InstructionType.R, "1100", "010")
        self.instructions["add"] = OpCode(
            "add", InstructionType.R, "1100", "011")
        self.instructions["sub"] = OpCode(
            "sub", InstructionType.R, "1100", "100")

        self.instructions["sll"] = OpCode(
            "sll", InstructionType.R, "1111", "000")
        self.instructions["cmp"] = OpCode(
            "cmp", InstructionType.R, "1110", "000")
        self.instructions["jr"] = OpCode(
            "jr", InstructionType.R, "1101", "000")
